...
import sumireko.util.MathHelper;

import static sumireko.SumirekoMod.makeEffectPath;
...
public class RuneParticleEffect extends AbstractGameEffect {
    ...
    //private static final Texture flash = TextureLoader.getTexture(makeEffectPath("flash.png"));
    //private static final Texture spark = TextureLoader.getTexture(makeEffectPath("spark.png"));
    static {
        runeAtlas = new TextureAtlas(Gdx.files.internal(makeEffectPath("rune.atlas")));
